...
namespace EFCore.NamingConventions.Test
{
    public class NameRewritingConventionTest
    {
        ...
        public void TPH_with_owned()
        {
            ...
            {
                b.Entity<Parent>();
                b.Entity<ChildWithOwner>().OwnsOne(c => c.Owned);
            });

            var parentEntityType = model.FindEntityType(typeof(Parent));
            var childEntityType = model.FindEntityType(typeof(ChildWithOwner));
        ...
        public class ChildWithOwner : Parent
        {
            public int ChildProperty { get; set; }
